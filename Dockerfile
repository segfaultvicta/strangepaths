...
#   - Ex: hexpm/elixir:1.19.0-rc.0-erlang-28.0.2-debian-bullseye-20250929-slim
#
...
RUN apt-get update -y && apt-get install -y libstdc++6 openssl libncurses5 locales fontconfig libvips-dev \
  && apt-get clean && rm -f /var/lib/apt/lists/*_*
