defmodule Strangepaths.Setup do
  def init do
    ...
    Strangepaths.Cards.create_card(%{
      ...
      aspect_id: 2,
      rules:
        "When you Engage in combat, draw +2 extra cards into your opening hand, rather than 1."
    })
    ...
    Strangepaths.Cards.create_card(%{
      ...
      aspect_id: 2,
      rules:
        "Strike 3 against a target which hasn't acted this round. This doesn't end your turn.",
      glory_rules:
    ...
    Strangepaths.Cards.create_card(%{
      ...
      glory_rules:
        "Strike 1. Against a target which has already acted this round, deal +5 damage."
    })
    ...
    Strangepaths.Cards.create_card(%{
      ...
      aspect_id: 3,
      rules:
        "Strike 2, and the enemy must target you if they perform an attack on their next turn.",
      glory_rules:
    ...
    Strangepaths.Cards.create_card(%{
      ...
      rules: "Strike 2.",
      glory_rules:
        "Strike 2. Select a random Rite from your discard pile and place it in your hand."
    })
    ...
    Strangepaths.Cards.create_card(%{
      ...
      glory_rules:
        "You gain +5 Divinity stacks. Place a card from your Discard pile into your hand."
    })
    ...
    Strangepaths.Cards.create_card(%{
      ...
      aspect_id: 13,
      rules:
        "Strike 2. Deals +1 damage for each Enchantment on the target, or status in their hand.",
      glory_rules:
