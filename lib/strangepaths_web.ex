defmodule StrangepathsWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: StrangepathsWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/strangepaths_web/templates",
        namespace: StrangepathsWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {StrangepathsWeb.LayoutView, "live.html"}
