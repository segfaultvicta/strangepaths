defmodule StrangepathsWeb.UserAuth do
  import Plug.Conn
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_strangepaths_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      StrangepathsWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def fetch_site_settings(conn, _opts) do
    assign(conn, :site_settings, Strangepaths.Site.get_site_settings())
  end
